"""
Localization module for Multi-Cancer AI.
Contains UI translations (IT/EN) and Medical Glossary.
"""
...
TRANSLATIONS = {
    "it": {
        ...
        "home_model_desc": "Modello caricato: {}",
        ...
        "diag_confidence": "Confidenza: {:.1f}%",
        "diag_time": "Tempo: {:.3f}s",
...
# Medical Glossary mapping folder names (substrings) to descriptions
MEDICAL_GLOSSARY = {
    "it": {
        # ALL
